...
namespace Document_Issuing_System.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HumanResourcesId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentToUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocumentToUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DocumentToUsers_Documents_DocumentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentToUsers_DocumentId",
                table: "DocumentToUsers",
                column: "DocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentToUsers_UserId",
                table: "DocumentToUsers",
                column: "UserId");
        }
